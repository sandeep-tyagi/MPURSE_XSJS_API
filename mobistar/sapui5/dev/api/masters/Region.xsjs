...
function deleteRegion() {
	...
	var record = {};
	try {
			var qryDeleteRegion = 'delete  from "MDB_DEV"."MST_REGION" where REGION_CODE=?';
...
function updateRegion() {
	...
	try {
		record = {};
		var CallPro = 'call "MDB_DEV"."com.mobistar.sapui5.dev.procedure::GetRegion"(?,?,?,?,?,?,?,?,?)';
...
function getRegionHierarchyDetails(regionCode , output){
 var record;
	...
	var branchArray = [];
		var connection = $.db.getConnection();
		try {
		    var CallProREGION = 'call "MDB_DEV"."com.mobistar.sapui5.dev.procedure::GetRegion"(?,?,?,?,?,?,?,?,?)';
			...
			var CallProSTATE = 'call "MDB_DEV"."com.mobistar.sapui5.dev.procedure::GetRegion"(?,?,?,?,?,?,?,?,?)';
			...
			var CallProDISTRICT = 'call "MDB_DEV"."com.mobistar.sapui5.dev.procedure::GetRegion"(?,?,?,?,?,?,?,?,?)';
			...
			var CallProAREA = 'call "MDB_DEV"."com.mobistar.sapui5.dev.procedure::GetRegion"(?,?,?,?,?,?,?,?,?)';
			...
			var CallProZONE = 'call "MDB_DEV"."com.mobistar.sapui5.dev.procedure::GetRegion"(?,?,?,?,?,?,?,?,?)';
			...
			var CallProBRANCH = 'call "MDB_DEV"."com.mobistar.sapui5.dev.procedure::GetRegion"(?,?,?,?,?,?,?,?,?)';
...
function fetchRegion(inputData,connection){
    var queryselectRegion = 'select * from "MDB_DEV"."MST_REGION" where SOFT_DEL is not null ';
    var whereClause = "";
