...
function getCustomerType() {
	...
	try {
		var CallgetCustomerType = 'call "MDB_DEV"."com.mobistar.sapui5.dev.procedure::MST_CUST_TYPE"(?,?,?,?,?,?,?,?,?)';
...
function getCustomerTypes() {
	...
	if (custTypeStatus === "Deleted") {
		qryCustType = 'SELECT * from "MDB_DEV"."MST_CUST_TYPE" where SOFT_DEL =\'1\'';
	} else if (custTypeStatus === "Active") {
		qryCustType = 'SELECT * from "MDB_DEV"."MST_CUST_TYPE" where SOFT_DEL=\'0\'';
	} else {
		qryCustType = 'SELECT * from "MDB_DEV"."MST_CUST_TYPE"';
	}
	...
	try {
		//var CallPro = 'call "MDB_DEV"."com.mobistar.sapui5.dev.procedure::MST_CUST_TYPE"(?,?,?,?,?,?,?,?,?)';
...
function fetchCustomerType(inputData, connection) {
	var querySelectCustType = 'select * from "MDB_DEV"."MST_CUST_TYPE" where SOFT_DEL is not null ';
	var whereClause = "";
...
function validateCustomerType(inputData, connection, record) {
	var CalladdCustomerType = 'call "MDB_DEV"."com.mobistar.sapui5.dev.procedure::MST_CUST_TYPE"(?,?,?,?,?,?,?,?,?);';
...
function updateCustomerType() {
	...
	try {
		var UpdCallCustomerType = 'call "MDB_DEV"."com.mobistar.sapui5.dev.procedure::MST_CUST_TYPE"(?,?,?,?,?,?,?,?,?);';
...
function deleteCustomerType() {
	...
	try {
		var CalldeleteCustomerType = 'call "MDB_DEV"."com.mobistar.sapui5.dev.procedure::MST_CUST_TYPE"(?,?,?,?,?,?,?,?,?);';
