 	...
 	try {
 		...
 		for (var i = 0; i < excelDataInJson.length; i++) {
 			...
 			var queryInvHeaderPost =
 				'insert into "MDB_TEST_INTEGRATION"."SALES_INVOICE_HEADER" ("INVOICE_NO","INVOICE_DATE","SAPUSER_ID","INVOICE_TYPE","BILL_TO_PARTY_CODE","BILL_TO_PARTY_NAME", ' +
 	...
 	try {
 		for (var i = 0; i < excelDataInJson.length; i++) {
 			...
 			var queryInvLinePost =
 				'insert into "MDB_TEST_INTEGRATION"."SALES_INVOICE_LINES" ("INVOICE_NO","INV_LINE_NUMBER","MATERIAL_CODE","QTY","SALES_PRICE","CGST", ' +
 ...
 function insertEquipment(dict, connection) {
 	...
 	try {
 		var queryInvEquiPost =
 			'insert into "MDB_TEST_INTEGRATION"."EQUIPMENT_MASTER" ("SERIAL_NUMBER","MATERIAL_CODE","INVOICE_NO","IMEI1", ' +
 ...
 function equitransUpload(dict, connection) {
 	...
 	try {
 		var queryInvEquiPost =
 			'insert into "MDB_TEST_INTEGRATION"."EQUIPMENT_MASTERTRANS" ("SERIAL_NO","MATERIAL_CODE","IMEI1","SAPUSER_ID", ' +
 ...
 function equipmentUpload(dict) {
 	...
 	var connection = $.db.getConnection();
 	try {
 		var queryselect = ' select SERIAL_NUMBER from "MDB_TEST_INTEGRATION"."EQUIPMENT_MASTER" where SERIAL_NUMBER = ? ';
 ...
 function equipmentEquiUpload(dict, connection) {
 	...
 	try {
 		var queryInvEquiPost =
 			'insert into "MDB_TEST_INTEGRATION"."SALES_INVOICE_EQUIP" ("INVOICE_NO","INVOICE_LINE_NO","MATERIAL_CODE","SERIAL_NO","IMEI1", ' +
