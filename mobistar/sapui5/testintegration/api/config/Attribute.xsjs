...
/**
 ...
 function getAttribute() {
 	...
 	try {
 		var CallProAttribute = 'call "MDB_TEST_INTEGRATION"."com.mobistar.sapui5.testintegration.procedure::MST_ATTRIBUTE"(?,?,?,?,?,?,?,?,?);';
 ...
 function fetchAttribute(inputData, connection) {
 	var querySelectAttribute = 'select * from "MDB_TEST_INTEGRATION"."MST_ATTRIBUTE" where SOFT_DEL is not null ';
 	var whereClause = "";
 	...
 	var rsSelectAttribute = pstmtSelectAttribute.executeQuery();
 	return rsSelectAttribute;
 }
 ...
 function addAttribute(inputData, connection, record) {
 	...
 	var addCallAttribute = 'call "MDB_TEST_INTEGRATION"."com.mobistar.sapui5.testintegration.procedure::MST_ATTRIBUTE"(?,?,?,?,?,?,?,?,?);';
 	...
 	pstmtaddCalladdAttribute.setString(5, inputData.createby);
 ...
 function updateAttrubute() {
 	...
 	try {
 		var UpdCallAttrubute = 'call "MDB_TEST_INTEGRATION"."com.mobistar.sapui5.testintegration.procedure::MST_ATTRIBUTE"(?,?,?,?,?,?,?,?,?);';
 		...
 		pstmtUpdCallAttrubute.setString(7, modifyby);
 ...
 function deleteAttribute() {
 	...
 	try {
 		var DelCallAttribute = 'call "MDB_TEST_INTEGRATION"."com.mobistar.sapui5.testintegration.procedure::MST_ATTRIBUTE"(?,?,?,?,?,?,?,?,?);';
 ...
 function getAttributeName() {
 	...
 	var record;
 	try {
 		var querygetAttributeName = 'select distinct Attribute_name from "MDB_TEST_INTEGRATION"."MST_ATTRIBUTE"';
