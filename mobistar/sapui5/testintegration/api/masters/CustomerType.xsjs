...
function getCustomerType() {
	...
	try {
		var CallCustType = 'call "MDB_TEST_INTEGRATION"."com.mobistar.sapui5.testintegration.procedure::MST_CUST_TYPE"(?,?,?,?,?,?,?,?,?)';
...
function updateCustomerType() {
	...
	try {
		var UpdCallCustType = 'call "MDB_TEST_INTEGRATION"."com.mobistar.sapui5.testintegration.procedure::MST_CUST_TYPE"(?,?,?,?,?,?,?,?,?);';
...
function deleteCustomerType() {
	...
	try {
		var deleteCallCustType = 'call "MDB_TEST_INTEGRATION"."com.mobistar.sapui5.testintegration.procedure::MST_CUST_TYPE"(?,?,?,?,?,?,?,?,?);';
